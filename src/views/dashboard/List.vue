<template>
  <div class="flex flex-col h-full overflow-hidden">
    ...
    <div class="flex-1">
      <RecycleScroller
        class="h-[calc(100vh-260px)] list-wrap"
        :items="staredRepos"
        :item-size="168"
        :buffer="100"
        key-field="id"
      ...
      >
        <div
          class="flex h-168 justify-center items-center flex w-full group border-b border-#d8dee4 hover:bg-gray-50 relative overflow-hidden"
        >
          <div class="flex-1 max-w-full px-20">
            <div class="p-0 m-0 text-size-20 font-bold flex items-center">
              <i
                class="i-ic-round-star text-yellow-500 mr-10 text-shadow-sm"
              ></i>
              <a
